...
public class ModifyProductScene {
    ...
    private Text modifyProductText;
    //left product box
    ...
    public ModifyProductScene(Stage stage, Product product){
        this.product = product;
        this.root = new HBox();
        this.root.setId("root");
        this.leftPanel = new VBox();
        this.root.getChildren().add(this.leftPanel);
        this.createModifyProductText();
        //left products box
        this.productBox = new GridPane();
        this.leftPanel.getChildren().add(this.productBox);
        this.createIdRow();
        this.createNameRow();
        this.createInvRow();
        this.createCostRow();
        ...
        this.root.getChildren().add(this.partsPane);
    ...
    private void createModifyProductText(){
        this.modifyProductText = new Text("Modify Product");
        this.modifyProductText.setId("title1");
        this.leftPanel.getChildren().add(this.modifyProductText);
    }
    private void createIdRow(){
        this.idText = new Text("ID");
        this.idField = new Text(Integer.toString(this.product.getId()));
        this.productBox.add(idText, 0, 0);
        this.productBox.add(idField, 1, 0, 2, 1);
    }
    private void createNameRow(){
        this.nameText = new Text("Name");
        this.nameField = new TextField(this.product.getName());
    ...
    private void createInvRow(){
        ...
        this.invField = new TextField(Integer.toString(this.product.getStock()));
    ...
    private void createCostRow(){
        ...
        this.priceField = new TextField(Double.toString(this.product.getPrice()));
    ...
    private void createMinMaxRow(){
        ...
        this.maxField = new TextField(Integer.toString(this.product.getMax()));
        this.minText = new Text("Min");
        this.minField = new TextField(Integer.toString(this.product.getMin()));
    ...
    private void createDeleteButton(){
        ...
        this.partsPane.add(this.deleteButton, 3, 10);
    }
    private void createSaveButton(){
        ...
        this.saveButton.setOnAction((event)->{            
            try{
                ...
                int stock = Integer.parseInt(this.invField.getText().trim());
                ...
                //check min/max/stock exception
                if(min > max || stock > max || stock < min){
                    throw new IllegalArgumentException();
                }
                //save
                Inventory.updateProduct(this.product, name, price, stock, min, max,
                        associatedParts);
                ...
                return;
            }catch(IllegalArgumentException minMax){
                ErrorBox error = new ErrorBox("You entered improper\nmin, max, or inv values.");
                return;
            }catch(RuntimeException price){
                ErrorBox error = new ErrorBox("The sum of the price of\nparts must be less than\nthe product price.");
                return;
            }
        });
